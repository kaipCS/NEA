...
for ($j=1; $j < 100; $j++){
    ...
    if (in_array($questionid, $diagrams)){
        if ($questionid == 1035){
            ...
            <img src="diagrams/1035-diagram-1.png" style="width: 10%; display: block; margin: 0 auto;">
            ...
            <img src="diagrams/1035-diagram-2.png" style="width: 10%; display: block; margin: 0 auto;">
            ...
            $code .= '<img src="' . $imageSrc . '" style="width: 10%; display: block; margin: 0 auto;">';
